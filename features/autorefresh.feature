Feature: auto refresh the test runner
  ...
  Scenario: default settings should not auto refresh
    ...
    Then the file "target/jasmine/SpecRunner.html" should not contain "<meta http-equiv=\"refresh\""

  @server
  Scenario: auto refresh every 5 seconds

    Given I am currently in the "jasmine-webapp-passing" project
    When I run "../../../../mvnw clean jasmine:bdd -Djasmine.autoRefreshInterval=5" in a new process
    And I load "http://localhost:8234" in a browser
    Then the file "target/jasmine/SpecRunner.html" should contain "<meta http-equiv=\"refresh\" content=\"5\">"

  Scenario: auto refresh should not apply to jasmine:test goal

    Given I am currently in the "jasmine-webapp-passing" project
    When I run "../../../../mvnw clean test -Djasmine.autoRefreshInterval=5"
