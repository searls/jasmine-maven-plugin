...
public class HtmlGeneratorConfigurationTest {
  ...
  public void shouldReadCustomTemplateWhenOneIsProvided() throws IOException {
    ...
    verify(ioUtilsWrapper, times(1)).toString(expected);
  }
  ...
  private HtmlGeneratorConfiguration initGenerator(IOUtilsWrapper ioUtilsWrapper, SpecRunnerTemplate template, InputStream customTemplate) throws IOException {
