...
public class ContextPathScriptResolverTest {
  ...
  public void testGetSourceDirectory() throws ScriptResolverException {
    Assertions.assertThat(this.contextPathScriptResolver.getSourceDirectory()).isEqualTo(SOURCE_CONTEXT_PATH);
  }

  @Test
  public void testGetSpecDirectory() throws ScriptResolverException {
    Assertions.assertThat(this.contextPathScriptResolver.getSpecDirectory()).isEqualTo(SPEC_CONTEXT_PATH);
  }
  ...
  public void testGetSources() throws ScriptResolverException {
    ...
    Assertions.assertThat(this.contextPathScriptResolver.getSources()).isEqualTo(expected);
  }
  ...
  public void testGetSpecs() throws ScriptResolverException {
    ...
    Assertions.assertThat(this.contextPathScriptResolver.getSpecs()).isEqualTo(expected);
  }
  ...
  public void testGetPreloads() throws ScriptResolverException {
    ...
    Assertions.assertThat(this.contextPathScriptResolver.getPreloads()).isEqualTo(expected);
  }
