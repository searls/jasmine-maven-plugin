...
public class HandlesRequestsForCoffee {
	...
	public void handle(Request baseRequest, HttpServletResponse response, Resource resource, boolean coffeeBareOption) throws IOException {
		baseRequest.setHandled(true);
		String javascript = compileCoffee(resource, coffeeBareOption);
	...
	private String compileCoffee(Resource resource, boolean coffeeBareOption) {
		try {
			return coffeeScript.compile(IOUtils.toString(resource.getInputStream()), coffeeBareOption);
		} catch(Exception e) {
