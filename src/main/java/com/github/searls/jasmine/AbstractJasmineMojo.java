...
public abstract class AbstractJasmineMojo extends AbstractMojo {
  ...
  /**
   * <p>An ordered list of filters to match script source files.</p>
   * 
   * <p>Often, you'll want to use sourceIncludes to control the ordering of your sources.
   * If your external dependencies need to be loaded first, you might:</p>
   * <pre>
   * &lt;sourceIncludes&gt;
